...
--
-- Host: 127.0.0.1
-- Czas generowania: 09 Lis 2022, 15:13
...
INSERT INTO `customers` (`id`, `customer_name`, `contact_name`, `address`, `city`, `post_code`, `country`) VALUES
...
CREATE TABLE `orders` (
  ...
  `shipper_id` varchar(300) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `orders` (`id`, `customer_id`, `employee_id`, `order_date`, `shipper_id`) VALUES
...
--
-- Struktura tabeli dla tabeli `shippers`
--
...
INSERT INTO `suppliers` (`id`, `name`, `contact_name`, `address`, `city`, `post_code`, `country`, `phone`) VALUES
...
--
ALTER TABLE `orders`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10444;
...
--
-- AUTO_INCREMENT dla tabeli `shippers`
--
ALTER TABLE `shippers`
